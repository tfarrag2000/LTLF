...
def Predict(solution, solution_idx=-1):
    ...
    s = "generation :" + str(ga_instance.generations_completed) + ", index :" + str(solution_idx) + ", count : " + str(
        ga_instance.count)
    print("****** " + s)
    Forecasting = LTLF.LTLF(stacked_layers_num=int(solution[0]),
                            Dense_neurons_n1=int(solution[1]),
                            Dense_neurons_n2=int(solution[2]),
                            Dropout=float(solution[3]),
                            n_neurons=int(solution[4]),
                            comment="Genetic Optimizer: " + s,
